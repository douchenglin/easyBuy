<template>
  <view class="carousel-3d-container" :style="{height: this.slideHeight + 'rpx'}">
    <view class="carousel-3d-slider" :style="{width: this.slideWidth + 'rpx', height: this.slideHeight + 'rpx'}">
      <slot></slot>
    </view>
  </view>
</template>
...
/* eslint-disable */
  ...
  export default {
    ...
    methods: {
      ...
      setSize () {
        this.$el.style.cssText += 'height:' + this.slideHeight + 'rpx;'
        this.$el.childNodes[0].style.cssText += 'width:' + this.slideWidth + 'rpx;' + ' height:' + this.slideHeight + 'rpx;'
      }
    },
    mounted () {
